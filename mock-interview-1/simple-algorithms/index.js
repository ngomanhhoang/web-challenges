...
console.log(maxOfTwoNumbers(-100, -23));
...
function averageWordLength(words) {
  ...
  console.log("Length array: ", lengthArr);

  const totalEachWord = words
    .map((word) => {
      return word.length;
    })
    .reduce((a, b) => {
  ...
  console.log("Total: ", totalEachWord);

  const average = totalEachWord / lengthArr;
  console.log(average);
}

averageWordLength(["eclipse", "harmony", "cascade"]);
...
console.log("Sum:", sum(["banana", 80, true, false]));
