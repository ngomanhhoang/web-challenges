...
function greet(person1, person2, person3) {
  console.log("Welcome " + person1 + ", good to see you again!")
  console.log("Welcome " + person2 + ", good to see you again!")
  console.log("Welcome " + person3 + ", good to see you again!")
}
...
// --v-- write your code here --v--
function logSeparator(sign, number) {
  console.log(sign);
